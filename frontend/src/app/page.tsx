                ...
                <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center">
                    ...
                    <div className="text-left">
                        <p className="text-gray-700 text-base leading-relaxed">
                            GeneSurvive is a machine learning-based web
                            application developed to predict the survivability
                            of breast cancer patients using clinical data and
                            gene expression profiles. Built on the METABRIC
                            dataset, which contains 31 clinical features, 331
                            mRNA expression levels, and 175 gene mutation
                            records, GeneSurvive helps estimate whether a
                            patient is likely to survive, along with a
                            confidence score. This tool aims to support research
                            in personalized cancer prognosis and treatment
                            strategies. While GeneSurvive provides valuable
                            insights from data, it is intended for educational
                            and research purposes only—not for clinical
                            diagnosis.
                        </p>
                    </div>
                </div>
